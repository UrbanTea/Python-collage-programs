...
while aga.lower()=='y':
    ...
    if rDraw=='y' or rDraw=="Y":
        ...
        while pPower >9 or pPower<1:
            pPower=int(input("enter Mega power number:"))
    ...
    if correctNum>0:
        score=(((1*10**int(correctNum/2))*((correctPos+1)*2)))
    if pPower==dPower:
        print("you have", correctNum,"correct numbers and",correctPos,"of thoes numbers are in the correct position and you got the Mega power number")
        score=score*10
    else:
        print("you have", correctNum,"correct numbers and",correctPos,"of thoes numbers are in the correct position and you did not get the Mega power number")
    tscore=tscore+score
